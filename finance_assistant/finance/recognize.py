...
«Т-Банк»/«Тинькофф» — Т-Банк; «Альфа-Онлайн» — Альфа-Банк."""
...
- card_last4: последние 4 цифры карты ИЛИ счёта списания («Карта списания •8445», \
«Счет списания 4081…0723», «Мастер-счет •2928» → 8445, 0723, 2928); иначе "".
...
(видны последние цифры другой его карты или «перевод между своими счетами»);
